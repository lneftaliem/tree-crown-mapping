...
- **License:** Fine-tuning / analysis code released on GitHub; the upstream architecture and training framework (Kariryaa et al.; Brandt et al., 2020) is MIT-licensed. The fine-tuned weights are **available on request** from the corresponding author — a redistribution license has not yet been assigned. [Assign an explicit weights license before public release.]
